package archive.calcs.calcasfunction.prototype1experiments.curried

import archive.calcs.calcasfunction.prototype1experiments.SharedModel._
  ...
  object Calc {
    ...
    implicit def CalcTriviallyHasRepository[T: HasRepository, R : HasRepository](implicit ev: HasRepository[R]): HasRepository[Calc[T, R]] =
      new HasRepository[Calc[T, R]] {
        override def dataConceptName: String = "N/A archive.calcs are not serializable"
...
object DemoCurriedFn extends App {
  ...
  // Building archive.calcs requires injecting implicit CalcRepository and HasRepository[_]s
